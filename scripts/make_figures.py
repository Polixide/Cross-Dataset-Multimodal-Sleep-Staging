...
Usage:
    python scripts/make_figures.py --metrics results/tables/ml_metrics.json \
        --probs results/logs/ml_test_probs.npz --data data/processed/sleep_edf.npz
"""
import argparse
import sys
...
from src.evaluate import reliability_curve
from src.utils import STAGE_NAMES, ensure_dir, get_logger, load_json
...
def main():
    ...
    parser.add_argument("--metrics", default="results/tables/ml_metrics.json")
